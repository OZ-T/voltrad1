...
psql -h localhost -d $USERNAME1 -U $USERNAME1 -p 5432 -a -w -f ~/voltrad/sql/opt_chain_ib.sql
psql -h localhost -d $USERNAME1 -U $USERNAME1 -p 5432 -a -w -f ~/voltrad/sql/opt_chain_yhoo.sql
