...
store_in1 = pd.HDFStore("C:/Users/David/Dropbox/proyectos/data/" + 'optchain_ib_hist_db.h5')
store_in2 = pd.HDFStore("C:/Users/David/Dropbox/proyectos/data/" + 'optchain_ib_hist_db_original.h5')
store_out = pd.HDFStore("C:/Users/David/Dropbox/proyectos/data/" + "optchain_ib_hist_db_full.h5")
