...
def coppock(globalconf, log_analytics, last_date, symbol="SPX",period="1D"):
    ...
    log_analytics.info(("Date for the report", last_date))
    log_analytics.info(("Last record stored underlying DB", last_record_stored))
    log_analytics.info(("Days missing in underlying DB", dias_que_faltan_en_db))
